                ...
                <div class="dashboard-container">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-4 col-md-offset-1 text-center">
                            ...
                            <a href="#" class="btn add-task" v-on:click.prevent="toAddTask">
                                add task
                            </a>
                            <a href="#" class="btn edit-prof" v-on:click.prevent="toProfile">
                                edit profile
                            </a>
                            <a href="#" class="btn exit" v-on:click.prevent="toWelcomePage">
                                exit
                            </a>
                        </div>
